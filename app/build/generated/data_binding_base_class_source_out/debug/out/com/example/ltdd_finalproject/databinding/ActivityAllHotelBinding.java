...
public final class ActivityAllHotelBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityAllHotelBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAllHotelBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_all_hotel, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAllHotelBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.listviewHotel;
      ListView listviewHotel = ViewBindings.findChildViewById(rootView, id);
      if (listviewHotel == null) {
        break missingId;
      }
