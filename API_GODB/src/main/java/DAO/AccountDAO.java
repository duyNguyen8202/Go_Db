    ...
    public AccountDAO(Connection conn) {
	   ...
	   public List<Account> getAllAccounts() throws SQLException {
	    	...
	    	while (rs.next()) {
	    		...
	    		Account account = new Account(account_id, username, account_type, customer_id, staff_id,acc_status,acc_password);
	   ...
	   public void addAccount(Account account) throws SQLException {
	    ...
	    {
	    	String sql = "UPDATE Account SET username= ?, account_type=?, customer_id=?, staff_id=?, acc_status=?, acc_password=? WHERE account_id=?";
	    	PreparedStatement stmt = conn.prepareStatement(sql);
	    ...
	    public void deleteAccount(Account account) throws SQLException {
	    	String sql = "UPDATE Account SET acc_status = false WHERE account_id=?";;
	    	PreparedStatement stmt = conn.prepareStatement(sql);
	    	stmt.setString(1, account.getAccountId());
	    	stmt.executeUpdate();
	        }
