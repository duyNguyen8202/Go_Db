...
//		stmt.setDate(8, new java.sql.Date(customer.getBirthDay().getTime()));
		stmt.setDate(8, customer.getBirthDay());
		stmt.executeUpdate();
	}
...
//            String formattedBirthDay = new SimpleDateFormat("yyyy/MM/dd").format(birthDay);
            ...
            Customer customer = new Customer(customer_id, full_name, email, phone_number, image_link, cus_address, gender,
                    birthDay);
...
//          stmt.setDate(7, new java.sql.Date(customer.getBirthDay().getTime()));
