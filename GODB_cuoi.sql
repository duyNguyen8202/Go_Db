...
CHECK (LEN(acc_password) >= 6 AND 
       acc_password NOT LIKE '%[^a-zA-Z0-9]%' AND 
       acc_password LIKE '%[0-9]%');
...
(1, 'Nguyen Van A', '1990-01-01', 1, '123 Nguyen Trai, Hanoi', '0987654321', 'nguyenvana@gmail.com', NULL, 'ID123456', 100000.00),
(2, 'Tran Thi B', '1995-05-10', 0, '456 Le Loi, Danang', '0123456789', 'tranthib@gmail.com', NULL,'ID789012', 8000000.00),
(3, 'Pham Van C', '1988-11-30', 1, '789 Nguyen Hue, HCMC', '0912345678', 'phamvanc@gmail.com', NULL, 'ID345678', 12000000.00),
(4, 'Le Thi D', '1992-07-15', 0, '456 Tran Phu, Nha Trang', '0367890123', 'lethid@gmail.com', NULL,'ID901234', 9000000.00),
(5, 'Hoang Van E', '1993-04-20', 1, '321 Cao Thang, Da Lat', '0543210987', 'hoangvane@gmail.com', NULL, 'ID567890', 11000000.00);
...
(1, 1, 1, 'Tour Ha Long Bay', 'Hanoi - Quang Ninh', '2023-06-01', '2023-06-04', 10, 5000000.00, NULL, 1),
(2, 2, 2, 'Tour Sapa', 'Hanoi - Lao Cai', '2023-07-01', '2023-07-04', 15, 7000000.00, NULL, 0),
(3, 3, 3, 'Tour Hoi An - Da Nang', 'HCMC - Da Nang', '2023-08-01', '2023-08-04', 20, 6000000.00, NULL, 1),
(4, 4, 4, 'Tour Nha Trang', 'HCMC - Khanh Hoa', '2023-09-01', '2023-09-04', 12, 8000000.00, NULL, 1),
(5, 5, 5, 'Tour Phu Quoc', 'HCMC - Kien Giang', '2023-10-01', '2023-10-04', 8, 9000000.00, NULL, 0);
...
INSERT INTO Room (room_id, hotel_id, room_number, room_type, rental_rate, room_capacity, room_status)
VALUES
    (1, 1, '101', 'Single', 50.00, 1, 'Available'),
    (2, 1, '102', 'Double', 75.00, 2, 'Occupied'),
    (3, 2, '201', 'Single', 50.00, 1, 'Available'),
    (4, 2, '202', 'Double', 80.00, 2, 'Under Maintenance'),
    (5, 3, '301', 'Suite', 150.00, 4, 'Available');

INSERT INTO Account (account_id, username, account_type,staff_id , customer_id, acc_status,acc_password)
VALUES 
(1,'ac1', 'Customer', NULL, 1,0,'test123'),
(2,'ac2', 'Customer', NULL, 2,0,'test123'),
(3,'ac3', 'Staff', 2, NULL,0,'test123'),
(4,'ac4', 'Staff', 3, NULL,1,'test123');